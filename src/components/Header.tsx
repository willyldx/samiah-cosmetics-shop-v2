      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <button aria-label="Rechercher" className="text-gray-400 hover:text-charcoal transition-colors">
              <Search className="w-5 h-5" strokeWidth={1.5} />
            </button>
            <button aria-label="Panier" className="relative text-gray-400 hover:text-charcoal transition-colors">
