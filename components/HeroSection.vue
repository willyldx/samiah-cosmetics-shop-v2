<template>
  <section class="relative min-h-[90vh] flex items-center overflow-hidden bg-white">
    <div class="absolute inset-0">
      ...
      <div class="absolute bottom-0 left-1/4 w-96 h-96 bg-gold/5 rounded-full blur-3xl"></div>
    </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div class="space-y-8">
          ...
          <p class="text-lg text-gray-600 max-w-lg leading-relaxed">
            Definition de votre profil capillaire, analyse des problemes, correction des habitudes et mise en place d'une routine personnalisee.
          </p>

          <div class="flex flex-wrap gap-4">
            <a class="group inline-flex items-center gap-3 bg-charcoal hover:bg-charcoal-800 text-white font-bold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1" :href="whatsappLink" target="_blank" rel="noopener">
              <span>Reserver - 10 000 F</span>
            ...
            <NuxtLink to="/produits" class="group inline-flex items-center gap-3 bg-transparent border-2 border-charcoal text-charcoal font-bold px-8 py-4 rounded-full transition-all duration-300 hover:bg-charcoal hover:text-white">
          ...
          <div class="flex flex-wrap items-center gap-6 pt-4 text-sm text-gray-500">
            ...
            <div class="flex items-center gap-2">
              <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>
        ...
        <div class="relative order-first lg:order-last">
          <div class="relative">
            ...
            <div class="relative rounded-2xl overflow-hidden shadow-lg bg-gray-100 aspect-[4/5]">
              <img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&q=80" alt="Soins capillaires Samiah Cosmetics" class="w-full h-full object-cover" loading="eager" />
    ...
    <div class="absolute bottom-8 left-1/2 -translate-x-1/2 hidden lg:block">
      <div class="w-6 h-10 rounded-full border-2 border-charcoal/20 flex items-start justify-center p-2">
...
const whatsappLink = computed(() => {
  const message = encodeURIComponent('Bonjour Samiah Cosmetics, je souhaite reserver une consultation capillaire (10.000F).')
