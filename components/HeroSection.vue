      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div class="space-y-8">
          ...
          >
            ...
            <span class="text-sm font-medium">{{ settings.badge_text }}</span>
          </div>
          ...
          >
            ...
            <span class="block mt-2">
              ...
              <span class="relative inline-block">
                <span class="text-gold">{{ settings.title_highlight }}</span>
                <svg 
          ...
          <div class="relative group">
            ...
            >
              <div class="flex items-center gap-2">
                <span class="text-gold text-lg">{{ ratingStars }}</span>
                <span class="text-sm font-bold text-charcoal">{{ settings.rating.toFixed(1) }}</span>
              </div>
            </div>
          </div>
        </div>
