<template>
  <div class="animate-pulse" :class="wrapperClass">
    ...
    <template v-else-if="type === 'product-detail'">
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-4 py-8">
          ...
          <div class="h-14 bg-gray-200  rounded-2xl w-full mt-6"></div>
        </div>
      </div>
    </template>
    <!-- Order Card Skeleton -->
    ...
    <template v-else-if="type === 'avatar'">
      <div class="rounded-full bg-gray-200 " :class="sizeClass"></div>
    </template>
    <!-- Image Skeleton -->
    <template v-else-if="type === 'image'">
      <div class="bg-gray-200  rounded-2xl" :class="aspectClass"></div>
    </template>
    <!-- Button Skeleton -->
    <template v-else-if="type === 'button'">
      <div class="h-12 bg-gray-200  rounded-xl" :class="widthClass"></div>
    </template>
    <!-- Default Box Skeleton -->
    <template v-else>
      <div class="bg-gray-200  rounded-xl" :class="[heightClass, widthClass]"></div>
    </template>
  </div>
</template>
