        ...
        <div class="flex-1 min-w-[200px]">
          <div class="relative">
            ...
            <input
              ...
              class="w-full pl-10 pr-4 py-2.5 bg-gray-50  border border-gray-200  rounded-xl focus:ring-2 focus:ring-gold/50 focus:border-gold outline-none text-charcoal "
            />
          </div>
        </div>
